...
import '../controller/kisakosatelite_controller.dart';
import 'appointment_request_from.dart';

class SatelliteListScreen extends StatefulWidget {
  @override
  _KioskListScreenState createState() => _KioskListScreenState();
}

class _KioskListScreenState extends State<SatelliteListScreen> {

  final KisakosateliteController kisakosateliteController =
  Get.put(KisakosateliteController());
